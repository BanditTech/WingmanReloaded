UtilityMenu(GuiCtrl, *){
	...
	If !Built.Has(slot)
	{
		...
		UtilitySliders[slot]["Life"] := Progress_Slider(UtilityGui[slot], "Utility" slot "Life_Slide" , x+40 , y , 145 , h , 0 , 100 , WR.Utility.%slot%.Life , backColor , setColor , 1 , "Utility" slot "Life" , 0 , 0 , 1)
		setColor := "51DEFF"
		...
		UtilitySliders[slot]["ES"] := Progress_Slider(UtilityGui[slot], "Utility" slot "ES_Slide" , x+40 , y , 145 , h , 0 , 100 , WR.Utility.%slot%.ES , backColor , setColor , 1 , "Utility" slot "ES" , 0 , 0 , 1)
		setColor := "Blue"
		...
		UtilitySliders[slot]["Mana"] := Progress_Slider(UtilityGui[slot], "Utility" slot "Mana_Slide" , x+40 , y , 145 , h , 0 , 100 , WR.Utility.%slot%.Mana , backColor , setColor , 1 , "Utility" slot "Mana" , 0 , 0 , 1)
