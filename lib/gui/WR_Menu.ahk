...
WR_Menu(Function:="",Var*){
  ...
  If (Function = "Inventory") {
    ...
    If !Built_Strings
    {
      ...
      StringsGui.Add("ComboBox", "xp y+8 w220 vHealthBarStr", HealthBarStr '??"' 1080_HealthBarStr '"?"' 1440_HealthBarStr '"?"' 1440_HealthBarStr_Alt '"?"' 1050_HealthBarStr '"').OnEvent("Change", UpdateStringEdit)
      ...
      StringsGui.Add("ComboBox", "y+8 w280 vSkillUpStr", SkillUpStr '??"' 1080_SkillUpStr '"?"' 1440_SkillUpStr '"?"' 1050_SkillUpStr '"?"' 768_SkillUpStr '"').OnEvent("Change", UpdateStringEdit)
      StringsGui.Add("Text", "xs y+15 Section", "Capture of the words Sell Items")
      StringsGui.Add("ComboBox", "y+8 w280 vSellItemsStr", SellItemsStr '??"' 1080_SellItemsStr '"?"' 2160_SellItemsStr '"?"' 1440_SellItemsStr '"?"' 1050_SellItemsStr '"?"' 768_SellItemsStr '"').OnEvent("Change", UpdateStringEdit)
      StringsGui.Add("Text", "x+10 ys", "Capture of the Stash")
      StringsGui.Add("ComboBox", "y+8 w280 vStashStr", StashStr '??"' 1080_StashStr '"?"' 2160_StashStr '"?"' 1440_StashStr '"?"' 1050_StashStr '"?"' 768_StashStr '"').OnEvent("Change", UpdateStringEdit)
      StringsGui.Add("Text", "xs y+15 Section", "Capture of the X button")
      StringsGui.Add("ComboBox", "y+8 w280 vXButtonStr", XButtonStr '??"' 1080_XButtonStr '"?"' 1440_XButtonStr '"?"' 1050_XButtonStr '"?"' 768_XButtonStr '"').OnEvent("Change", UpdateStringEdit)
      StringsGui.Opt("+Delimiter|")
      ...
      StringsGui.Add("ComboBox", "y+8 w280 vVendorStr", VendorStr '??"' 1080_MasterStr '"?"' 1080_NavaliStr '"?"' 1080_HelenaStr '"?"' 1080_ZanaStr '"?"' 2160_NavaliStr '"?"' 1440_ZanaStr '"?"' 1440_NavaliStr '"?"' 1050_MasterStr '"?"' 1050_NavaliStr '"?"' 1050_HelenaStr '"?"' 1050_ZanaStr '"?"' 768_NavaliStr '"?"' 1440_JunStr '"').OnEvent("Change", UpdateStringEdit)
      StringsGui.Add("Text", "x+10 ys", "Capture of the Azurite Mines vendor nameplate")
      StringsGui.Add("ComboBox", "y+8 w280 vVendorMineStr", VendorMineStr '??"' 1080_MasterStr '"?"' 1050_MasterStr '"').OnEvent("Change", UpdateStringEdit)
      StringsGui.Add("Text", "xs y+15 Section", "Capture of the Lioneye vendor nameplate")
      StringsGui.Add("ComboBox", "y+8 w280 vVendorLioneyeStr", VendorLioneyeStr '??"' 1080_BestelStr '"?"' 1050_BestelStr '"').OnEvent("Change", UpdateStringEdit)
      StringsGui.Add("Text", "x+10 ys", "Capture of the Forest vendor nameplate")
      StringsGui.Add("ComboBox", "y+8 w280 vVendorForestStr", VendorForestStr '??"' 1080_GreustStr '"?"' 1050_GreustStr '"').OnEvent("Change", UpdateStringEdit)
      StringsGui.Add("Text", "xs y+15 Section", "Capture of the Sarn vendor nameplate")
      StringsGui.Add("ComboBox", "y+8 w280 vVendorSarnStr", VendorSarnStr '??"' 1080_ClarissaStr '"?"' 1050_ClarissaStr '"').OnEvent("Change", UpdateStringEdit)
      StringsGui.Add("Text", "x+10 ys", "Capture of the Highgate vendor nameplate")
      StringsGui.Add("ComboBox", "y+8 w280 vVendorHighgateStr", VendorHighgateStr '??"' 1080_PetarusStr '"?"' 1050_PetarusStr '"').OnEvent("Change", UpdateStringEdit)
      StringsGui.Add("Text", "xs y+15 Section", "Capture of the Overseer vendor nameplate")
      StringsGui.Add("ComboBox", "y+8 w280 vVendorOverseerStr", VendorOverseerStr '??"' 1080_LaniStr '"?"' 1050_LaniStr '"').OnEvent("Change", UpdateStringEdit)
      StringsGui.Add("Text", "x+10 ys", "Capture of the Bridge vendor nameplate")
      StringsGui.Add("ComboBox", "y+8 w280 vVendorBridgeStr", VendorBridgeStr '??"' 1080_HelenaStr '"?"' 1050_HelenaStr '"').OnEvent("Change", UpdateStringEdit)
      StringsGui.Add("Text", "xs y+15 Section", "Capture of the Docks vendor nameplate")
      StringsGui.Add("ComboBox", "y+8 w280 vVendorDocksStr", VendorDocksStr '??"' 1080_LaniStr '"?"' 1050_LaniStr '"').OnEvent("Change", UpdateStringEdit)
      StringsGui.Add("Text", "x+10 ys", "Capture of the Oriath vendor nameplate")
      StringsGui.Add("ComboBox", "y+8 w280 vVendorOriathStr", VendorOriathStr '??"' 1080_LaniStr '"?"' 1050_LaniStr '"').OnEvent("Change", UpdateStringEdit)
      StringsGui.Add("Text", "xs y+15 Section", "Capture of the Harbour vendor nameplate")
      StringsGui.Add("ComboBox", "y+8 w280 vVendorHarbourStr", VendorHarbourStr '??"' 1080_FenceStr '"').OnEvent("Change", UpdateStringEdit)
      StringsGui.Add("Text", "x+10 ys", "Capture of the Kingsmarch vendor nameplate")
      StringsGui.Add("ComboBox", "y+8 w280 vVendorKingsmarchStr", VendorKingsmarchStr '??"' 1080_IslaStr '"').OnEvent("Change", UpdateStringEdit)
      StringsGui.Opt("+Delimiter|")
