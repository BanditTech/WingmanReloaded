readFromFile(){
	...
	;Ascii strings
	HealthBarStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "HealthBarStr", 1080_HealthBarStr)
	If HealthBarStr
		OHBStrW := StrSplit(StrSplit(HealthBarStr, "$")[2], ".")[1]
	ChestStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "ChestStr", 1080_ChestStr)
	DelveStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "DelveStr", 1080_DelveStr)
	VendorStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "VendorStr", 1080_MasterStr)
	SellItemsStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "SellItemsStr", 1080_SellItemsStr)
	StashStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "StashStr", 1080_StashStr)
	SkillUpStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "SkillUpStr", 1080_SkillUpStr)
	XButtonStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "XButtonStr", 1080_XButtonStr)
	VendorLioneyeStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "VendorLioneyeStr", 1080_BestelStr)
	VendorForestStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "VendorForestStr", 1080_GreustStr)
	VendorSarnStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "VendorSarnStr", 1080_ClarissaStr)
	VendorHighgateStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "VendorHighgateStr", 1080_PetarusStr)
	VendorOverseerStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "VendorOverseerStr", 1080_LaniStr)
	VendorBridgeStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "VendorBridgeStr", 1080_HelenaStr)
	VendorDocksStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "VendorDocksStr", 1080_LaniStr)
	VendorOriathStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "VendorOriathStr", 1080_LaniStr)
	VendorHarbourStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "VendorHarbourStr", 1080_FenceStr)
	VendorKingsmarchStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "VendorKingsmarchStr", 1080_IslaStr)
	VendorMineStr := IniRead(A_ScriptDir "\save\Settings.ini", "FindText Strings", "VendorMineStr", 1080_MasterStr)
