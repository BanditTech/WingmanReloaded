...
class ItemScan
{
	__New(){
		...
		This.Pseudo := Map()
		This.Affix := Map()
		This.Prop := {Rarity:"", ItemClass:"", Rarity_Digit:0, ClusterJewel:False, SlotType:"", RarityUnique:False, IsWeapon:False, Quiver:False, WantedCraftingBase:False, HeistGear:False, Influence:"", RarityCurrency:False, RarityDivination:False, RarityGem:False, RarityNormal:False, RarityMagic:False, RarityRare:False}
		This.Modifier := Map()
		This.Percent := Map()
