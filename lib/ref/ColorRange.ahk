...
ColorRange(c1, c2) { ; Create a list of colors between two https://www.autohotkey.com/boards/viewtopic.php?t=29205
  ...
  ColorList.Push(Color1.RGB)
  Loop MCD - 1
    ColorList.Push("0x" Format("{:02X}", Color1.R + A_Index / MCD * Distance_R)
                      . Format("{:02X}", Color1.G + A_Index / MCD * Distance_G)
                      . Format("{:02X}", Color1.B + A_Index / MCD * Distance_B))
  ColorList.Push(Color2.RGB)
  Return ColorList
}
