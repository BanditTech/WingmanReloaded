...
; Capture GUI for FindText
  ...
  Gui, Font, s10
  	...
  	Gui, Add, text, x+0 yp w35, %ft_ww%
	Gui, Add, UpDown, vft_ww Range1-110, %ft_ww%
  	Gui, Add, text, x+5 yp w35, Height: %A_Space%
  	Gui, Add, text, x+0 yp w35, %ft_hh%
	Gui, Add, UpDown, vft_hh Range1-40, %ft_hh%
  ...
  ft_towz(color,wz,comment="")
  {
    ...
    Global ExportString .= "|<" comment ">" color "$" wz 
...
*/ ; 
    CheckOHB()
    {
        ...
        If WinActive(GameStr)
        {
            ...
            if (ok:=FindText(GameX + Round((GameW / 2)-52), GameY + Round(GameH / (1080 / 177)), 104, Round(GameH / (1080 / 370)) - Round(GameH / (1080 / 177)), 0, 0, HealthBarStr))
            {
                ok.1.3 -= 1
                ok.1.4 += 8
