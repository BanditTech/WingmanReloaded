...
window.$docsify.plugins = [].concat((n, e) => {
  ...
  localStorage && (t = !0),
    (window.changelogDisplayHandler = function() {
      // alert('test');
      if (
        (document.getElementById("CHANGELOG_RENDERER").classList.toggle("show"),
        t && null === localStorage.getItem(o))
      ) {
  ...
  if (null === i && ((i = document.querySelector("nav")), null === i))
        ...
        (ht.onreadystatechange = function() {
          !(function(n) {
            ...
            t && localStorage.getItem(c)
              ? (l =
                  '<a href="javascript:void(0);" onClick="window.changelogDisplayHandler(); return false;" id="CHANGELOG">CHANGELOG</a>\n                <div id="CHANGELOG_RENDERER">\n                  <div class="CL_content">\n                    <div class="CL_content-body"></div>\n                  </div>\n                </div>')
              : ((l =
                  '<a href="javascript:void(0);" onClick="window.changelogDisplayHandler(); return false;" id="CHANGELOG"><i id="CHANGELOG_NOTIFY"></i>  CHANGELOG</a>\n                <div id="CHANGELOG_RENDERER">\n                  <div class="CL_content">\n                    <div class="CL_content-body"></div>\n                  </div>\n                </div>'),
                (o = c));
            i.innerHTML = a
              .map(n => n.trim())
              .slice(1, a.length - 1)
          ...
          ht.open("GET", e.config.changelog.path, !0),
          ht.send();
      })();
  });
  n.mounted(function() {
    ...
    if (Object.isObject(a)) {
      ...
      if (Object.isObject(a.window)) {
        (u.window.height = a.window.height || u.window.height),
          ...
          (u.window.portrait_height =
            a.window.portrait_height || u.window.portrait_height),
          (u.window.portrait_width =
            a.window.portrait_width || u.window.portrait_width),
          (u.window.background = a.window.background || u.window.background),
          (u.window.scroll_track =
            a.window.scroll_track || u.window.scroll_track),
          (u.window.scroll_button =
            a.window.scroll_button || u.window.scroll_button),
          (u.window.border = a.window.border || u.window.border),
          (u.window.shadow = a.window.shadow || u.window.shadow),
          (u.window.shadow_params =
            a.window.shadow_params || u.window.shadow_params),
          (u.window.offset_right =
            a.window.offset_right || u.window.offset_right);
      }
      if (Object.isObject(a.button)) {
        (u.button.notify = a.button.notify || u.button.notify),
          ...
          (u.button.text_transition =
            a.button.text_transition || u.button.text_transition),
          (u.button.background = a.button.background || u.button.background),
          (u.button.background_hover =
            a.button.background_hover || u.button.background_hover),
          (u.button.background_transition =
            a.button.background_transition || u.button.background_transition),
          (u.button.brightness_hover =
            a.button.brightness_hover || u.button.brightness_hover),
          (u.button.position = a.button.position || u.button.position),
          (u.button.offset_right =
            a.button.offset_right || u.button.offset_right);
      }
      ...
      if (Object.isObject(a.text)) {
        ...
        (u.text.all = a.text.all || u.text.all),
          ...
          (u.text.strong_background =
            a.text.strong_background || u.text.strong_background),
          ...
          (u.text.blockquote_background =
            a.text.blockquote_background || u.text.blockquote_background),
          (u.text.list = a.text.list || u.text.list),
          (u.text.list_background =
            a.text.list_background || u.text.list_background),
      ...
      if (Object.isObject(a.link)) {
        (u.link.text = a.link.text || u.link.text),
          ...
          (u.link.text_transition =
            a.link.text_transition || u.link.text_transition),
          (u.link.background = a.link.background || u.link.background),
          (u.link.background_hover =
            a.link.background_hover || u.link.background_hover),
          (u.link.background_transition =
            a.link.background_transition || u.link.background_transition);
      }
    } else {
      u.path = a;
    }
    document.documentElement.style.setProperty(
      `--changelog-window-height`,
      `${u.window.height}`
    ),
      document.documentElement.style.setProperty(
        `--changelog-window-width`,
        `${u.window.width}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-window-portrait-height`,
        `${u.window.portrait_height}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-window-portrait-width`,
        `${u.window.portrait_width}`
      ),
      document.documentElement.style.setProperty(
      ...
      document.documentElement.style.setProperty(
        `--changelog-window-scroll-track`,
        `${u.window.scroll_track}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-window-scroll-button`,
        `${u.window.scroll_button}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-window-border`,
        `${u.window.border}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-window-shadow`,
        `${u.window.shadow}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-window-shadow-params`,
        `${u.window.shadow_params}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-window-offset-right`,
        `${u.window.offset_right}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-button-notify`,
        `${u.button.notify}`
      ),
      document.documentElement.style.setProperty(
      ...
      document.documentElement.style.setProperty(
        `--changelog-button-text-hover`,
        `${u.button.text_hover}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-button-text-transition`,
        `${u.button.text_transition}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-button-background`,
        `${u.button.background}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-button-background-hover`,
        `${u.button.background_hover}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-button-background-transition`,
        `${u.button.background_transition}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-button-brightness-hover`,
        `${u.button.brightness_hover}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-button-position`,
        `${u.button.position}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-button-offset-right`,
        `${u.button.offset_right}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-header-auto-links`,
        `${u.header.auto_links}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-header-border-edge`,
        `${u.header.border_edge}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-header-h1-text`,
        `${u.header.h1_text}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-header-h2-text`,
        `${u.header.h2_text}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-header-h3-text`,
        `${u.header.h3_text}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-header-h4-text`,
        `${u.header.h4_text}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-header-h1-background`,
        `${u.header.h1_background}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-header-h2-background`,
        `${u.header.h2_background}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-header-h3-background`,
        `${u.header.h3_background}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-header-h4-background`,
        `${u.header.h4_background}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-header-h1-size`,
        `${u.header.h1_size}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-header-h2-size`,
        `${u.header.h2_size}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-header-h3-size`,
        `${u.header.h3_size}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-header-h4-size`,
        `${u.header.h4_size}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-text-all`,
      ...
      document.documentElement.style.setProperty(
        `--changelog-text-strong-background`,
        `${u.text.strong_background}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-text-p`,
      ...
      document.documentElement.style.setProperty(
        `--changelog-text-p-background`,
        `${u.text.p_background}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-text-blockquote`,
        `${u.text.blockquote}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-text-blockquote-background`,
        `${u.text.blockquote_background}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-text-list`,
      ...
      document.documentElement.style.setProperty(
        `--changelog-text-list-background`,
        `${u.text.list_background}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-text-list-icon`,
        `${u.text.list_icon}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-link-text`,
      ...
      document.documentElement.style.setProperty(
        `--changelog-link-text-hover`,
        `${u.link.text_hover}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-link-text-transition`,
        `${u.link.text_transition}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-link-background`,
        `${u.link.background}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-link-background-hover`,
        `${u.link.background_hover}`
      ),
      document.documentElement.style.setProperty(
        `--changelog-link-background-transition`,
        `${u.link.background_transition}`
      );
...
function clickoutside(e) {
  if (
    document.getElementById("CHANGELOG_RENDERER").contains(e.target) != true &&
